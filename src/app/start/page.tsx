...
const investigations = {
    ...
    "quiet-dressing-room": {
        ...
        intro: [
            "Театр имени Лунина. Час до премьеры. В гримёрке находят актрису без сознания.",
            "Дверь не взломана. Сцена не готова. Подозреваемых больше, чем ролей.",
            "Ты не полицейский. Ты тот, кто слышит, как ложь фальшиво звучит в тишине.",
            "Раздели правду и спектакль. Добро пожаловать за кулисы."
        ],
    },
};
